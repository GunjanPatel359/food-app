            ...
            <div className="lg:w-[70%] m-auto">
                ...
                {userRating ? (
                    <>
                        ...
                        <div className="flex mb-2 p-2">
                            <div className="flex">
                                <div className="flex">
                                    <div className="p-3">
                                        <img src={`${img_url}/${userRating.userId.avatar}`} className="w-[55px] h-[55px] rounded-full" />
                                    </div>
                                    <div className="ml-3">
                                        <div>
                    ...
                    <div className="border border-color3 p-4 rounded">
                        ...
                        <div>
                            <RatingForm maxRatingCount={5} color={color5} size={50} hotelId={hotel._id} />
                        </div>
                    </div>
                )}
...
const RatingForm = ({ maxRatingCount = 5, color, size, hotelId }) => {
