...
const AdditionalSettingsSeller = ({setTheme,theme}) => {
  ...
  useEffect(()=>{
    const initiatePage=async()=>{
      try {
        const res=await axios.get(`${backend_url}/seller/colors/all-the-colors`,{withCredentials:true})
  ...
  const changeColor=async()=>{
    try {
      const res=await axios.patch(`${backend_url}/seller/colors/change-color`,{color:theme},{withCredentials:true})
      if(res.data.success){
