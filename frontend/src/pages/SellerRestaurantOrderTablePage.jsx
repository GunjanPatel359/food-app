        ...
        const initialCom = async () => {
            try {
                ...
                if (response.data.success) {
                    ...
                    setFilteredFood(response.data.food)
                }
            } catch (error) {
                ...
                <tbody>
                    {item.map((item, index) => (
                        <tr key={index} className="border-b border-color3">
                            ...
                            <td className="py-2 text-right text-color4">{item.price.toFixed(2)}</td>
                            <td className="py-2 text-center text-color4">{item.quantity}</td>
                            <td className="py-2 text-right text-color4">{(item.price * item.quantity).toFixed(2)}0</td>
                        </tr>
                    ))}
                </tbody>
            </table>
